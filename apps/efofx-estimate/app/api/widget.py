...
@widget_router.post(
    ...
    description="Save a prospect lead from the widget. Requires API key authentication.",  # noqa: E501
    status_code=201,
)
async def capture_lead(
    ...
    logger.info(
        "Lead captured for tenant %s, session %s", tenant.tenant_id, lead.session_id
    )
...
@widget_router.get(
    ...
    description=(
        ...
        "Returns daily event counts for widget_view, chat_start, and estimate_complete. "  # noqa: E501
