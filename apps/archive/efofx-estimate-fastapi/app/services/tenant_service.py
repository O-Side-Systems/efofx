...
class TenantService:
    ...
    async def get_tenant_by_api_key(self, api_key: str) -> Optional[Tenant]:
        """Get tenant by API key (legacy plaintext lookup — superseded by hashed key auth)."""  # noqa: E501
        try:
    ...
    async def get_tenant_statistics(self, tenant_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            estimates_col = get_tenant_collection(
                DB_COLLECTIONS["ESTIMATES"], tenant_id
            )
            ...
            # Get average rating — TenantAwareCollection.aggregate() prepends $match for tenant_id  # noqa: E501
    ...
    async def get_all_tenant_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Cross-tenant raw access — intentionally unscoped (platform-level admin stats)  # noqa: E501
