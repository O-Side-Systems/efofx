...
class ReferenceService:
    ...
    def _classes_collection(
        self, tenant_id: Optional[str] = None, allow_platform: bool = True
    ):
        """
    ...
    async def get_reference_statistics(
        ...
        try:
            ...
            # Aggregate pipelines — TenantAwareCollection prepends $match with tenant filter  # noqa: E501
            region_pipeline = [
            ...
            class_stats = await (await projects_col.aggregate(class_pipeline)).to_list(
                None
            )
