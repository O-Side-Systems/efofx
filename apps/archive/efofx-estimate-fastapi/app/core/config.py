...
class Settings(BaseSettings):
    ...
    # Optional: when None, feedback emails log the magic link URL to console for dev testing  # noqa: E501
    RESEND_API_KEY: Optional[str] = None

    # Application base URL (for verification links in emails)
    APP_BASE_URL: str = "http://localhost:8000"

    # Error Tracking (Optional - Sentry removed but keeping config for backwards compatibility)  # noqa: E501
